package com.goglotek.mpesareconciliation.mpesareconciliationuiservice.exception.handler;

import com.goglotek.mpesareconciliation.mpesareconciliationuiservice.exception.*;
...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler(MpesaFileNotFoundException.class)
    ...
    @ExceptionHandler(MpesaFetchedTransNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleMpesaFetchedTransNotFoundException(Exception ex, WebRequest request) {
        return new ResponseEntity<>(generateErrorResponse(ex, request, 404, "CODE_1"), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(MpesaReconTransactionsNotFoundException.class)
    ...
    @ExceptionHandler(MpesaReconciliationsNotFoundException.class)
