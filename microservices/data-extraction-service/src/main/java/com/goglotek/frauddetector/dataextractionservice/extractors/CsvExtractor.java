...
public class CsvExtractor implements DataExtractor {
  ...
  @Override
  public List<Transaction> extractTransactions(byte[] fileData, Schema schema)
      throws IOException, GoglotekException {
      ...
      try (InputStreamReader reader = new InputStreamReader(inputStream)) {
        if (schema.hasHeaders()) {
          ...
          throw new UnimplementedFeatureException(
              "Extracting csv file with no headers is not implemented yet. Contract Goglotek for implementation");
        }
      }
    }
    return transactions;
