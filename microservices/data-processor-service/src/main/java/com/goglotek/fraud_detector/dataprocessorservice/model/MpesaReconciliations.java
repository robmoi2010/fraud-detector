...
@Entity
@Table(name = "mpesa_reconciliations")
public class MpesaReconciliations implements Serializable {
	/**
	 * 
	 */
	...
	@SequenceGenerator(name = "recon_sequence", sequenceName = "mpesa_reconciliations_sq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "recon_sequence")
