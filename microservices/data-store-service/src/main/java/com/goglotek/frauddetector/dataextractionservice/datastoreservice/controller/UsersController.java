...
import com.goglotek.frauddetector.dataextractionservice.datastoreservice.exception.UserNotFoundException;
...
import com.goglotek.frauddetector.dataextractionservice.datastoreservice.dto.CreateUserDto;
import com.goglotek.frauddetector.dataextractionservice.datastoreservice.dto.FilterModel;
import com.goglotek.frauddetector.dataextractionservice.datastoreservice.dto.UserDto;
...
public class UsersController {
    ...
    public @ResponseBody Users findByEmail(@RequestParam(name = "email", required = true) String email) {
    ...
    public @ResponseBody Users updateUser(@RequestBody CreateUserDto userDto, @PathVariable("id") Long userId) {
        Users user = userService.findById(userId).orElseThrow(() -> new UserNotFoundException("No user with ID " + userId));
        user.setAccountVerified(userDto.isAccountVerified());
        user.setFailedLoginAttempts(userDto.getFailedLoginAttempts());
        user.setFirstName(userDto.getFirstName());
        user.setLastName(userDto.getLastName());
    ...
    public @ResponseBody UserDto filteredUsers(@RequestParam(name = "page", required = true) Integer page,
