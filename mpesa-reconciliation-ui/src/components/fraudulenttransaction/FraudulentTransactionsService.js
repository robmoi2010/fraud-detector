...
class FraudulentTransactionsService {
	constructor() {
		this.restClient = new RestClient();
	}
	async retrieveFraudulentTransactions(page, pageSize, orderBy, direction, filterModel, accessToken) {
		var obj = {
			method: 'POST',
			headers: {
...
export default FraudulentTransactionsService;